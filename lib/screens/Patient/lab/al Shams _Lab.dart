...
class ALShamsScreen extends StatefulWidget {
  ...
  static String id = 'ALShamsScreen';

  @override
  State<ALShamsScreen> createState() => _ALShamsScreenState();
}

class _ALShamsScreenState extends State<ALShamsScreen> {
  String LabName = 'Al shams lab';
