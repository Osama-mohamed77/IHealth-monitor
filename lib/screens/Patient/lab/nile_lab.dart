...
class NileScreen extends StatefulWidget {
  const NileScreen({Key? key}) : super(key: key);
  static String id = 'NileScreen';

  @override
  State<NileScreen> createState() => _NileScreenState();
}

class _NileScreenState extends State<NileScreen> {
  String LabName = 'Nile lab';
