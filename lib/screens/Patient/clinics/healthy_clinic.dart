...
class HealthyClinic extends StatefulWidget {
  const HealthyClinic({Key? key}) : super(key: key);
  static String id = 'HealthyClinic';

  @override
  State<HealthyClinic> createState() => _HealthyClinicState();
}

class _HealthyClinicState extends State<HealthyClinic> {
  String clinicName = 'Healthy house clinic';
...
//   String idAdham = '5PnNKYfuedcqcyd5QNWAcQ1ezZb2';
//   String entryId = '';
//   @override
//   void initState() {
//     super.initState();
